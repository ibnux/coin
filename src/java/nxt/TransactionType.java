...
public abstract class TransactionType {
    ...
    public static abstract class ColoredCoins extends TransactionType {
        ...
        public static final TransactionType ASSET_INCREASE = new ColoredCoins() {
            ...
            @Override
            Attachment.ColoredCoinsAssetIncrease parseAttachment(ByteBuffer buffer) {
                return new Attachment.ColoredCoinsAssetIncrease(buffer);
            }
        ...
        public static final TransactionType ASSET_PROPERTY_SET = new ColoredCoinsAssetPropertyTransactionType() {
            ...
            @Override
            Attachment.ColoredCoinsAssetProperty parseAttachment(ByteBuffer buffer) throws NxtException.NotValidException {
                return new Attachment.ColoredCoinsAssetProperty(buffer);
            }
        ...
        public static final TransactionType ASSET_PROPERTY_DELETE = new ColoredCoinsAssetPropertyTransactionType() {
            ...
            @Override
            Attachment.PropertyDeleteAttachment parseAttachment(ByteBuffer buffer) {
                return new Attachment.ColoredCoinsAssetPropertyDelete(buffer);
            }
