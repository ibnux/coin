...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "NUX";
    public static final String ACCOUNT_PREFIX = "NUX";
    public static final String PROJECT_NAME  = "iBNuXCoin";
    ...
    public static final long FEE_NXT = 1000;
